...
import (
	...
	account "github.com/whatDeepak/microservice-arch/account"
	catalog "github.com/whatDeepak/microservice-arch/catalog"
	"github.com/whatDeepak/microservice-arch/order/pb"
...
func (s *grpcServer) PostOrder(ctx context.Context, r *pb.PostOrderRequest) (*pb.PostOrderResponse, error) {
	...
	// Get ordered products in that order
	productIDs := []string{}
	...
	// Call service implementation -> Create order
